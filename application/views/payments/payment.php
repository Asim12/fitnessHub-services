            ...
            <div class="content-page">
                <div class="content" style="margin-top: 2%">
                    ...
                    <div class="container-fluid">
                        <form method="POST" action="<?php echo base_url();?>index.php/admin/Payment/index">
                            <div class="row">
                                <div class="col-xl-4">
                                    <label>From: </label>
                                    <input type="date" value="<?=(!empty($filterPayment['start_date']) ? $filterPayment['start_date'] : "")?>"  class="form-control filters_style_input" placeholder="start date" name="start_date" />
                                </div> <!-- end col -->

                                <div class="col-xl-4">
                                    <label>To: </label>
                                  <input type="date" value="<?=(!empty($filterPayment['end_date']) ? $filterPayment['end_date'] : "")?>" class="form-control filters_style_input" placeholder="end date"  name="end_date" />
                                </div> <!-- end col -->

                                <div class="col-xl-4">  
                                    <label style="display: block;">Search: </label>
                                    <button type="submit" class="form-control filters_style_input filter button">Filter</button>
                                    <a class= "form-control filters_style_input filter buttonReset"href="<?php echo base_url();?>index.php/admin/Payment/resetFilter">Reset</a>
                                ...
                                <div class="card-box boxStyle filters_style" style= "margin-top: 3%">
                                    <div class="table-responsive"> 
                                        <table class="table table-centered table-hover mb-0">
                                            ...
                                            <tbody>  
                                            <?php foreach ($trasections as $index) {?>
                                                <tr>
                                                    <td>  
                                                        <img src="<?php echo SURL;?>assets/images/male.png" alt="" class="rounded-circle images avatar-sm bx-shadow-lg image2">
                                                        <span style="padding-left: 2%; color:black"><?php echo  (!empty($index['profile_data'])) ? $index['profile_data'][0]['name'] : '---'; ?></span>
                                                    </td>
                                                    <td>12/23/2021</td>
                                                    <td> Saturday </td>
